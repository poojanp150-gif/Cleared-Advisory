                ...
                <div className="container--boxed">
                    ...
                    <div className="max-w-360 mx-auto section-2xl w-full flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
                        ...
                        <div className="flex flex-col lg:w-45% w-full lg:sticky lg:top-30">
                            ...
                            <h2 className="font-gelasio font-medium text--2xl sm:text--2xl md:text--4xl leading-tight md:leading-15 tracking--0.48px text-white mt-4">
                                ...
                                >
                                    ...
                                    <div className="flex-1 flex flex-col gap-3">
                                        ...
                                        <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                                            ...
                                            {pillar.tag && (
                                                <span className="font-space-grotesk font-medium text--2xs sm:text--xs tracking-1.1px bg-gradient-to-r from-brand-blue-900 to-brand-blue-800 bg-clip-text text-transparent uppercase select-none">
                                                    {pillar.tag}
                                                </span>
                                            )}
                                        </div>
