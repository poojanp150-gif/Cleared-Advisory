        ...
        <div className="w-full flex flex-col">
            ...
            <div className="w-full min-h-132 bg-gradient-to-b from-brand-blue-900 to-brand-blue-800 flex flex-col relative overflow-hidden pt-22">
                ...
                <div className="flex-1 flex items-center justify-center px-6 lg:px-20 py-15 lg:py-30 relative z-10">
                    <div className="flex flex-col items-center text-center   w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <h1 className="font-gelasio font-medium text--4xl sm:text--7xl md:text--9xl leading-tight md:leading-19 tracking--0.64px sm:tracking--0.48px text-white">
                            End-to-end AML/CTF{" "}
                            <br className=" " />
                            <span className="italic font-medium bg-clip-text what-we-do__highlight-text-gold text-transparent">
                                compliance.
                            </span>
                        </h1>
            ...
            <section className="w-full bg-white  text-slate-900 flex flex-col items-center">
                <div className="container--boxed">
                    ...
                    <div className="max-w-360 mx-auto section-1xl sm:section-2xl w-full">
                        {/* Header */}
                        <div className="max-w-300 mx-auto flex flex-col items-start text-left mb-6 sm:mb-16">
                            <span className="font-space-grotesk font-medium text--2xs sm:text--xs tracking-1.1px text-[#666666] uppercase">
                                Our clients
                            </span>
                            <h2 className="font-gelasio font-medium text--3xl  md:text--7xl leading-tight tracking--0.48px text-brand-900 mt-4">
                                Who we work with
                            </h2>
                            <p className="font-space-grotesk font-normal text--xs sm:text--lg md:text-18px leading-7 text-[#666666] max-w-195 mt-4">
                        ...
                        <div className="max-w-300 mx-auto border border-black/10 divide-y divide-black/10 rounded-sm overflow-hidden w-full flex flex-col">
                            {clients.map((client, idx) => (
                                <div
                                    key={idx}
                                    className="group relative bg-white p-6 sm:p-10 md:p-12  z-10 flex flex-col md:flex-row gap-6 md:gap-12 items-start"
                                >
                                    {/* Large Muted Number */}
                                    <span className="font-space-grotesk font-medium text--4xl sm:text--7xl leading-none tracking--1.44px text-black/10 select-none md:pt-1">
                                        {client.number}
                                    </span>
                                    ...
                                    <div className="flex-1 flex flex-col gap-3">
                                        ...
                                        {/* Description */}
                                        <p className="font-space-grotesk font-normal text--xs sm:text--base text-[#666666] leading-6 max-w-249">
                                            {client.description}
                                        </p>
                                    </div>
                                </div>
            ...
            <section className="w-full bg-gradient-to-b from-brand-blue-900 to-brand-blue-800  text-white flex justify-center border-t border-white/10">
                <div className="container--boxed">
                    ...
                    <div className="max-w-360 mx-auto section-1xl sm:section-2xl w-full flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
                        {/* Left Column (Sticky Header Content) */}
                        <div className="flex flex-col lg:w-45% w-full lg:sticky lg:top-30">
                            <span className="font-space-grotesk font-medium text--2xs sm:text--xs tracking-1.1px uppercase text-white/60">
                                Our three pillars
                            </span>
                            <h2 className="font-gelasio font-medium text--3xl  md:text--7xl leading-tight md:leading-15 tracking--0.48px text-white mt-4">
                                Advisory. Operations. Audit.
                            </h2>
                            <p className="font-inter font-normal text--xs sm:text--lg leading-7 text-white/80 max-w-120 mt-3 sm:mt-6">
                            ...
                            {pillars.map((pillar, idx) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 flex flex-col gap-3">
                                        ...
                                        {/* Description */}
                                        <p className="font-inter font-normal text--xs sm:text--base text-[#666666] leading-6">
                                            {pillar.description}
                                        </p>
                                    </div>
                                </div>
