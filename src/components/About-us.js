...
export default function Services() {
    return (
        <div className="w-full flex flex-col">
            ...
            <div className="w-full min-h-[527px] bg-gradient-to-b from-[#010132] to-[#1D1D81] flex flex-col relative overflow-hidden pt-[89px]">
                ...
                <div className="flex-1 flex items-center justify-center px-6 lg:px-20 py-16 lg:py-[120px] relative z-10">
                    <div className="flex flex-col items-center text-center gap-6 max-w-[844px] w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <span className="font-space-grotesk font-medium text--xs tracking-[1.4px] uppercase bg-gradient-to-r from-[#CCAB51] via-[#D5B45F] to-[#E7C77C] bg-clip-text text-transparent">
                            Services & pricing
                        </span>
                ...
                <div className="container--boxed">
                    ...
                    <div className="max-w-[1440px] mx-auto section-2xl w-full flex flex-col items-center">
                        ...
                        <div className="flex flex-col items-center text-center ">
                            ...
                            <h2 className="font-gelasio font-medium text--2xl sm:text--2xl md:text-[48px] leading-tight tracking-[-0.48px] text-[#111827] mt-4">
                        ...
                        <div className="w-full max-w-[1200px] grid grid-cols-1 md:grid-cols-2 p-[48px] items-stretch">
                            {/* Card 1 */}
                            <div className="group relative flex flex-col justify-between p-8 sm:p-10 min-h-[320px] bg-[#FDFDF9] border border-[#D4AF37] ">
                                <div className="flex flex-col gap-6">
                                    <div>
                                        ...
                                        <h3 className="font-gelasio font-medium text--xl sm:text-[28px] text-[#111827] tracking-[-0.28px] leading-snug">
                                            Cleared to proceed
                                        </h3>
                                    </div>
            ...
            <section className="w-full bg-gradient-to-t from-[#1D1D81] to-[#010132]   text-white flex flex-col items-center relative overflow-hidden">
                ...
                <div className="container--boxed">
                    <div className="max-w-[1440px] mx-auto section-2xl w-full flex flex-col items-center relative z-10">
                        ...
                        {/* Quote Text */}
                        <h2 className="font-gelasio font-medium text--xl sm:text--2xl md:text-[40px] leading-snug md:leading-[56px] tracking-[-0.4px] text-center max-w-[900px]">
                ...
                <div className="container--boxed">
                    ...
                    <div className="max-w-[1440px] mx-auto section-2xl w-full flex flex-col items-center">
                        ...
                        <div className="w-full max-w-[1200px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  items-stretch">
                            {/* Card 1 */}
                            <div className="group relative flex flex-col justify-between p-8 sm:p-10 min-h-[307px] bg-[#FDFDF9] border border-[#E5E7EB] rounded-[4px] hover:border-[#CCAB51]/30">
                                <div className="flex flex-col gap-6">
                                    <h3 className="font-gelasio font-medium text--xl text-[#111827] tracking-[-0.24px] leading-snug">
            ...
            <section className="w-full bg-gradient-to-b from-[#010132] to-[#1D1D81]   text-white flex flex-col items-center relative overflow-hidden">
                <div className="container--boxed">
                    <div className="max-w-[1440px] mx-auto section-2xl w-full">
                        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            ...
                            <div className="flex flex-col justify-center max-w-[568px] w-full">
                                ...
                                {/* Heading */}
                                <h2 className="font-gelasio font-medium text--2xl sm:text--2xl md:text-[48px] leading-tight tracking-[-0.48px] text-white mt-6">
                            ...
                            <div className="relative flex justify-center lg:justify-end w-full lg:max-w-[568px] mt-12 lg:mt-0">
                                ...
                                <div className="absolute -left-4 sm:-left-8 bottom-8 w-[270px] h-[96px]  bg-gradient-to-r from-[#CCAB51] via-[#D5B45F] to-[#E7C77C]  border border-black/10 flex items-center px-6 py-6">
