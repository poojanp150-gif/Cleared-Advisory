    ...
    return (
        <>
            <div className="w-full flex flex-col">
                ...
                <div className="w-full bg-gradient-to-r from-[#CCAB51] via-[#D5B45F] to-[#E7C77C] py-7">
                    <div className="max-w-[1440px] mx-auto w-full px-6 lg:px-20">
                        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-black/10">
                            ...
                            <div className="py-4 md:py-0 flex flex-col items-center justify-center text-center">
                                <span className="font-space-grotesk font-medium text-[36px] leading-[48px] tracking-[-1.44px] text-slate-900">
                                    80,000+
                                </span>
                ...
                <section className="w-full bg-white text-slate-900  ">
                    <div className="container--boxed">
                        ...
                        <div className="max-w-[1200px] mx-auto w-full flex flex-col section-2xl">
