...
export default function WhatWeDo() {
    ...
    return (
        <div className="w-full flex flex-col">
                ...
                <div className="max-w-[1440px] mx-auto px-6 lg:px-20 w-full">
                    ...
                    <div className="max-w-[1200px] mx-auto border border-black/10 divide-y divide-black/10 rounded-sm overflow-hidden w-full flex flex-col">
                        {clients.map((client, idx) => (
                            <div
                                key={idx}
                                className="group relative bg-white p-8 sm:p-10 md:p-12 hover:bg-neutral-50/50 hover:scale-[1.01] hover:shadow-md transition-all duration-300 z-10 flex flex-col md:flex-row gap-6 md:gap-12 items-start"
                            >
                                {/* Large Muted Number */}
            ...
            <section className="w-full bg-gradient-to-b from-[#010132] to-[#1D1D81] py-20 lg:py-[120px] text-white flex justify-center border-t border-white/10">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-20 w-full flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
