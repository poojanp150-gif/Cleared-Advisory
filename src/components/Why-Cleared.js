...
export default function WhyCleared() {
    return (
        <div className="w-full flex flex-col">
                ...
                <div className="flex-1 flex items-center justify-center px-6 lg:px-20 py-15 lg:py-30">
                    <div className="flex flex-col items-center text-center  max-w-211 w-full">
                        ...
                        <h1 className="font-gelasio font-medium text--4xl sm:text--7xl md:text--9xl leading-[150%] md:leading-19 tracking--0.48px text-white">
                            ...
                            <span className="font-medium italic why-cleared__highlight-text-gold bg-clip-text text-transparent">model is broken.</span>
                        </h1>
                        {/* Description */}
            ...
            <section className="w-full bg-white  text-slate-900 border-b border-neutral-100 flex flex-col items-center">
                <div className="container--boxed">

                    <div className="max-w-360 mx-auto section-1xl sm:section-2xl w-full">
                        {/* Header */}
                        <div className=" mx-auto flex flex-col items-start sm:items-center text-left sm:text-center mb-12 sm:mb-16">
                            <span className="font-space-grotesk font-medium text--xs tracking-1.1px text-[#666666] uppercase">
                                OUR DIFFERENCE
                            </span>
                            <h2 className="font-gelasio font-medium text--3xl md:text--7xl leading-tight md:leading-15 tracking--0.48px text-brand-900 mt-3 sm:mt-6">
                                What businesses have always been told to do.
                            </h2>
                            <p className="font-space-grotesk font-normal text--base sm:text--lg md:text-18px leading-7 text-[#666666] max-w-195 w-full mx-auto mt-3 sm:mt-6">
                        ...
                        <div className="max-w-300 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch w-full">
                            {/* Card 1 */}
                            <div className="group relative bg-white rounded-sm p-6 sm:p-12 shadow-sm border border-black/10 hover:border-amber-400/30  flex flex-col gap-3 sm:gap-6 h-full overflow-hidden">
                                <h3 className="font-gelasio font-medium text--xl sm:text--2xl text-brand-900">
                                    Hire a law firm
                                </h3>
                                <p className="font-space-grotesk font-normal text--xs sm:text--base text-[#666666] leading-6">
            ...
            <section className="w-full bg-gradient-to-b from-brand-blue-900 to-brand-blue-800  text-white relative overflow-hidden">
                <div className="container--boxed">
                    ...
                    <div className="max-w-360 mx-auto section-1xl sm:section-2xl w-full flex justify-center">
                        {/* Centered Glass Quote Card */}
                        <div className="max-w-208 w-full p-0 sm:p-10 md:p-12  flex flex-col gap-8 md:gap-10">
                            {/* Profile Info (Header) */}
                            <div className="flex items-center gap-6">
                                {/* Avatar with Outside Gold Gradient Border */}
                                <div className=" w-22 h-22 sm:w-26 sm:h-26 rounded-full  p-1 bg-gradient-to-l from-brand-gold-500 via-brand-gold-400 to-brand-gold-300 flex items-center justify-center flex-shrink-0">
                            ...
                            {/* Quote Text */}
                            <p className="font-gelasio font-medium text--xl sm:text--2xl md:text--4xl leading-relaxed md:leading-12 tracking--0.24px sm:tracking--0.36px text-white">
                ...
                <div className="container--boxed">
                    ...
                    <div className="max-w-360 mx-auto section-1xl sm:section-2xl w-full">
                        ...
                        <div className="max-w-300 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch w-full">
                            ...
                            <div className="group relative bg-white rounded-4px p-6 sm:p-10 md:p-12  border border-black/10  flex flex-col gap-4 sm:gap-8 h-full overflow-hidden">
                                {/* Icon */}
                            ...
                            <div className="group relative bg-gradient-to-b from-brand-blue-900 to-brand-blue-800 rounded-4px p-6 sm:p-10 md:p-12  border border-white/10  flex flex-col gap-4 sm:gap-8 h-full overflow-hidden text-white">
                                {/* Icon */}
                                ...
                                <ul className="flex flex-col list-disc pl-5 w-full text-white">
                                    {[
                                        ...
                                        <li
                                            key={idx}
                                            className={`py-6 w-full border-t border-white/10
                                                }`}
                                        >
                                            <span className="font-space-grotesk font-normal text--xs sm:text--base text-white leading-6">
                                                {item}
                                            </span>
                                        </li>
                                    ))}
                    ...
                    <div className="max-w-320 mx-auto section-1xl sm:section-2xl w-full">
                        <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 items-start">
                            ...
                            <div className="flex flex-col  lg:sticky lg:top-24 max-w-144 w-full ">
                                ...
                                {/* Heading */}
                                <h2 className="font-gelasio font-medium text--3xl  md:text--7xl leading-tight md:leading-15 tracking--0.48px text-white mt-3 sm:mt-6">
                                    Three things we promise. Every client. Every time.
                                </h2>

                                {/* Description */}
                                <p className="font-inter font-normal text--xs sm:text--lg text-white/80 mt-3 sm:mt-6 leading-relaxed">
                            ...
                            <div className="flex flex-col gap-8 w-full lg:max-w-144">
                                {[
                                    ...
                                    <div
                                        key={idx}
                                        className="group relative bg-white rounded-sm p-8 sm:p-10 shadow-md border border-black/5 hover:border-amber-400/20 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col gap-3 sm:gap-6"
                                    >
                                        {/* Big faint number */}
                                        <div className="font-space-grotesk font-medium text--4xl sm:text--7xl leading-none text-slate-900/10 group-hover:text-amber-500/20 transition-colors duration-300">
                                            {card.number}
                                        </div>
            ...
            <section className="w-full bg-white  text-slate-900 flex flex-col items-center ">
                <div className="container--boxed ">
                    ...
                    <div className="max-w-360 mx-auto section-1xl sm:section-2xl   w-full flex flex-col items-center">
                        <div className="max-w-300 w-full flex flex-col gap-2 lg:gap-16">
                            ...
                            <div className="flex flex-col items-start text-left w-full gap-4 sm:gap-6">
                                ...
                                <h2 className="font-gelasio font-medium text--3xl  md:text--7xl leading-tight md:leading-15 tracking--0.48px text-brand-900">
                                    What makes a compliance program that actually survives an AUSTRAC audit.
                                </h2>
                                <p className="font-space-grotesk font-normal text--xs sm:text--base leading-relaxed text-[#666666] max-w-175">
                                ...
                                {[
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <h4 className="font-gelasio font-medium text--xl sm:text--2xl leading-tight tracking--0.24px text-brand-900">
                                                {item.title}
                                            </h4>
                                            <p className="font-space-grotesk font-normal text--xs sm:text--base text-[#666666] leading-6">
                                                {item.desc}
                                ...
                                <div className="flex flex-col w-full">
                                    {[
                                        ...
                                        >
                                            ...
                                            <span className="font-space-grotesk font-normal text--xs sm:text--base text-brand-900 leading-6">
                                                {sign}
                                            </span>
                                        </div>
                                    ))}
