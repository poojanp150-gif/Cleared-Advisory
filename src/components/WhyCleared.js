...
export default function WhyCleared() {
    return (
        <div className="w-full flex flex-col">
            ...
            <section className="w-full bg-white py-20 lg:py-[120px] text-slate-900 border-b border-neutral-100 flex flex-col items-center">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-20 w-full">
                    ...
                    <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch w-full">
                        {/* Card 1 */}
                        <div className="group relative bg-white rounded-sm p-8 sm:p-10 shadow-sm border border-black/10 hover:border-amber-400/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col gap-6 h-full overflow-hidden">
            ...
            {/* ── Founder Section ── */}
            <section className="w-full bg-gradient-to-b from-[#010132] to-[#1D1D81] py-20 lg:py-[120px] text-white relative overflow-hidden">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-20 w-full flex justify-center">
            ...
            <section className="w-full bg-[#F8F9FA] py-20 lg:py-[120px] text-slate-900 border-b border-neutral-200/50 flex flex-col items-center">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-20 w-full">
                    {/* Header */}
                    <div className="max-w-[1280px] mx-auto flex flex-col items-center text-center mb-12 sm:mb-16">
                        <span className="font-space-grotesk font-medium text-sm tracking-[1.1px] text-[#666666] uppercase">
                    ...
                    <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch w-full">
                        ...
                        <div className="group relative bg-white rounded-[4px] p-8 sm:p-10 md:p-12 shadow-sm border border-black/10 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col gap-8 h-full overflow-hidden">
                            {/* Icon */}
                        ...
                        <div className="group relative bg-gradient-to-b from-[#010132] to-[#1D1D81] rounded-[4px] p-8 sm:p-10 md:p-12 shadow-sm border border-white/10 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col gap-8 h-full overflow-hidden text-white">
                            {/* Icon */}
                            ...
                            {/* Expanding bottom gold gradient line */}
                            <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-gradient-to-r from-[#CCAB51] to-[#E7C77C] group-hover:w-full transition-all duration-300" />
                        </div>
            ...
            <section className="w-full bg-white pt-20 lg:pt-[120px] text-slate-900 flex flex-col items-center">
