        ...
        <div className="w-full flex flex-col">
            ...
            <div className="w-full min-h-105 bg-gradient-to-b from-brand-blue-900 to-brand-blue-800 flex flex-col relative overflow-hidden pt-22">
                <div className="flex-1 flex items-center justify-center px-6 lg:px-20 py-16">
                    <div className="flex flex-col items-center text-center gap-4 sm:gap-6 max-w-211 w-full animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <h1 className="font-gelasio font-medium text--2xl sm:text--4xl md:text--6xl leading-tight tracking--0.48px text-white">
                            Privacy <span className="italic font-medium privacy-policy__highlight-text-gold bg-clip-text text-transparent">Policy.</span>
                        </h1>
                        <p className="font-space-grotesk font-medium text--base sm:text--lg md:text-18px leading-7 text-white/80 max-w-202 mt-2">
            ...
            <section className="w-full bg-white  text-slate-900 flex flex-col items-center">
                <div className="container--boxed">
                    ...
                    <div className="max-w-360 mx-auto section-2xl w-full flex flex-col items-center">
                        <div className="w-full max-w-180 flex flex-col gap-10">

                            {/* Introduction */}
                            <div className="flex flex-col gap-6">
                                <p className="font-space-grotesk font-normal text--base text-brand-gray-600 leading-28.8px">
                            ...
                            {/* Section 1 */}
                            <div className="flex flex-col gap-6">
                                <h2 className="font-gelasio font-medium text--2xl sm:text-32px border-b-2 pb-5 border-black/5 leading-tight tracking--0.32px text-brand-gray-800">
                                ...
                                <ul className="flex flex-col gap-4 pl-4 sm:pl-6">
                                    <li>
                                        <span className="font-space-grotesk font-bold text--base text-brand-gray-600">Identity Information:</span>
                                        <span className="font-space-grotesk font-normal text--base text-brand-gray-600 ml-2">Name, job title, and company details.</span>
                                    </li>
                                    <li>
                                        <span className="font-space-grotesk font-bold text--base text-brand-gray-600">Contact Information:</span>
                                        <span className="font-space-grotesk font-normal text--base text-brand-gray-600 ml-2">Email address, phone number, and business address.</span>
                                    </li>
                                    <li>
                                        <span className="font-space-grotesk font-bold text--base text-brand-gray-600">Financial & Compliance Information:</span>
                                        <span className="font-space-grotesk font-normal text--base text-brand-gray-600 ml-2">Information necessary to conduct AML/CTF health checks, build compliance programs, and assist with AUSTRAC enrolment.</span>
                                    </li>
                                    <li>
                                        <span className="font-space-grotesk font-bold text--base text-brand-gray-600">Technical Data:</span>
                                        <span className="font-space-grotesk font-normal text--base text-brand-gray-600 ml-2">IP addresses, browser type, and usage data when you visit our website.</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <ul className="flex flex-col gap-4 pl-6 sm:pl-8 text-brand-gray-600 font-space-grotesk font-normal text--base leading-28.8px marker:text-brand-gold-600">
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <ul className="flex flex-col gap-4  pl-4 sm:pl-6 border-black/5">
                                    <li className="text-brand-gray-600 font-bold font-space-grotesk  text--base">
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                {/* Contact Box */}
                                <div className="mt-4 p-8 border border-brand-gray-200 bg-brand-bg-white flex flex-col gap-4 shadow-sm">
                                    <h3 className="font-space-grotesk font-bold text--base text-brand-gray-800">
                                        Cleared Advisory
                                    </h3>
                                    <p className="font-space-grotesk font-normal text--base text-brand-gray-600">
