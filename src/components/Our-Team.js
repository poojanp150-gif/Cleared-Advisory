            ...
            <section className="w-full bg-white  text-slate-900" >
                <div className="container--boxed">
                    <div className="max-w-360 mx-auto section-2xl w-full">
                        <div className="max-w-320 mx-auto flex flex-col xl:flex-row gap-12 lg:gap-24 items-start">
                            {/* Profile Card */}
                            <div className="w-full xl:w-95 bg-gradient-to-b from-brand-blue-900 to-brand-blue-800 border border-white/10 flex flex-col items-center p-10 shrink-0 rounded-4px our-team__shadow-card-light relative">
                            ...
                            <div className="flex-1 flex flex-col gap-8  pt-4 lg:pt-8">
                                <div className="border-l-4 border-l-brand-blue-900 ">
                                    <h2 className="font-gelasio font-medium text--2xl pl-4 lg:pt-5  lg:pl-10 sm:text--4xl leading-tight sm:leading-[50.4px] tracking--0.36px text-brand-900">
                                        &quot;I didn&apos;t build {" "}
                                ...
                                {/* Stats Cards */}
                                <div className="flex flex-col md:flex-row border-t border-slate-200 bg-white ml-9 w-full md:w-max ">
                                    <div className="flex flex-col items-center justify-center p-8 min-w-50">
                                        <span className="font-space-grotesk font-medium text--5xl leading-12 tracking--1.44px text-brand-900">80,000+</span>
                                        <span className="font-space-grotesk font-medium text--xs tracking-1.1px text-brand-gray-500 mt-2 text-center uppercase">BUSINESSES CAPTURED</span>
                                    </div>
                                    <div className="flex flex-col items-center justify-center p-8 min-w-50 ">
                                        <span className="font-space-grotesk font-medium text--5xl leading-12 tracking--1.44px text-brand-900">22</span>
                                        <span className="font-space-grotesk font-medium text--xs tracking-1.1px text-brand-gray-500 mt-2 text-center uppercase">YRS APAC EXPERIENCE</span>
                                    </div>
                                    <div className="flex flex-col items-center justify-center p-8 min-w-50 ">
                                        <span className="font-space-grotesk font-medium text--5xl leading-12 tracking--1.44px text-brand-900">3-in-1</span>
                                        <span className="font-space-grotesk font-medium text--xs tracking-1.1px text-brand-gray-500 mt-2 text-center uppercase">ADVISORY OPS · AUDIT</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container--boxed">
                    ...
                    <div className="max-w-360 mx-auto section-2xl w-full flex flex-col items-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3  w-full max-w-300">
                            <div className="flex flex-col items-start gap-4 p-12 bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                                <h3 className="font-gelasio font-medium text--2xl leading-9 tracking--0.24px text-white">
                                    Regulatory relationships
                                </h3>
                                <p className="font-space-grotesk font-normal text--base leading-6 text-white/80">
