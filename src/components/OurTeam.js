...
export default function OurTeam() {
    return (
        <div className="w-full flex flex-col">
            ...
            <section className="w-full bg-white py-20 lg:py-[120px] text-slate-900" >
            ...
            <section className="w-full bg-white py-20 lg:py-[100px] flex flex-col items-center" style={{ marginTop: "-1px" }}>
                <div className="max-w-[1440px]  mx-auto px-6 lg:px-20 w-full">
                    <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-2  items-stretch">
                        <div className="bg-[#FDFDF9] border-t border-b border-l border-r-0 border-[#D4AF37] p-10 flex flex-col gap-6 justify-between transition-all hover:border-[#CCAB51]/30 hover:shadow-md">
                            <div>
                        ...
                        <div className="bg-[#FDFDF9] border-t border-b border-l border-r-0 border-[#D4AF37] p-10 flex flex-col gap-6 justify-start transition-all hover:border-[#CCAB51]/30 hover:shadow-md">
                            <div>
                                <h3 className="font-gelasio font-medium text-[28px] text-[#111827] leading-snug tracking-[-0.28px] mb-4">
            ...
            {/* ── The Network ── */}
            <section className="w-full bg-gradient-to-b from-[#010132] to-[#1D1D81] py-20 lg:py-[120px] text-white flex flex-col items-center">
