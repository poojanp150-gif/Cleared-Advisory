  ...
  return (
    ...
    <div className="relative  bg-slate-950 text-white">
      ...
      <div className="relative z-10 flex flex-col min-h-screen pt-[89px]">
        ...
        <section id="services" className="w-full bg-[#F8F9FA]  text-slate-900 relative">
          <div className="container--boxed">
        ...
        <section className="w-full bg-white text-slate-900 relative">
          <div className="container--boxed">
            <div className="max-w-[1440px] mx-auto section-2xl w-full flex flex-col items-center">
              <div className="max-w-[1200px] w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
                ...
                <div className="flex flex-col justify-start max-w-[568px] w-full">
                  ...
                  <div className="mt-10 max-w-[363px] w-full">
                    <Link
                  ...
                  <p className="font-space-grotesk font-normal text-[12px] text-slate-400 mt-6 leading-relaxed max-w-[448px]">
                ...
                <div className="flex flex-col gap-8 w-full max-w-[568px]">
